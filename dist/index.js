...
function format(xml, options = {}) {
    ...
    const parser = __nccwpck_require__(7739);
...
var settings = __nccwpck_require__(9724);
var os = __nccwpck_require__(857);
var path = __nccwpck_require__(6928);
var fs = __nccwpck_require__(9896);
var axios = __nccwpck_require__(7269);
...
var path = __nccwpck_require__(6928);
var fs = __nccwpck_require__(9896);
var DOMParser = (__nccwpck_require__(8351).DOMParser);
var XMLSerializer = (__nccwpck_require__(8351)/* .XMLSerializer */ .e);
var format = __nccwpck_require__(6450);
