...
[![CodeFactor](https://www.codefactor.io/repository/github/step-security/maven-settings-xml-action/badge)](https://www.codefactor.io/repository/github/step-security/maven-settings-xml-action) ![build-test](https://github.com/step-security/maven-settings-xml-action/workflows/build-test/badge.svg)
...
```yaml
- uses: step-security/maven-settings-xml-action@v22
  with:
